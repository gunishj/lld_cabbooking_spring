...
import static com.gunishjha.cabbooking.model.TripStatus.FINISHED;
import static com.gunishjha.cabbooking.model.TripStatus.IN_PROGRESS;
...
public class Trip {
    ...
    public void endTrip(){this.status=FINISHED;}
